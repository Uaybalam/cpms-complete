            ...
            <div class="alert alert-info bg-white p-4 rounded shadow">
                ...
                @if ($cantidad !== null)
                    <input type="text" class="form-control" name="total" id="total" placeholder="total"
                        aria-label="total" value="{{ $sumaTotal + $cantidad->cantidad_inicial }}" readonly>
                @else
                    <input type="text" class="form-control" name="total" id="total" placeholder="total"
                        aria-label="total" value="0.00" readonly>
                @endif
                <label class="form-label">Cantidad Inicial $:</label>
                @if ($cantidad !== null)
                    <input type="text" class="form-control" name="Cantidad" id="Cantidad" placeholder="Cantidad"
                        aria-label="cantidad" value="{{ $cantidad->cantidad_inicial }}" readonly>
                @else
                    <input type="text" class="form-control" name="Cantidad" id="Cantidad" placeholder="Cantidad"
                        aria-label="cantidad" value="0.00" readonly>
                @endif
                <br>
