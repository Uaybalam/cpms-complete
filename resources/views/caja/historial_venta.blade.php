                    ...
                    <tbody>
                        @foreach ($registros as $registro)
                            <tr>
                                ...
                                <td><a href="{{ route('mostrar.Factura', $registro->id) }}" target="_blank"><img
                                            src="https://png.pngtree.com/png-vector/20220606/ourlarge/pngtree-pdf-file-icon-png-png-image_4899509.png"
