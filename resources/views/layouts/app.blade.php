            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © 2023 CPMSys</span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Desarrollado por <i class="fa fa-heart text-danger"></i> by <a href="#" class="text-dark" target="_blank">ADefiant Systems</a></span>
                    </div>
                </footer>
